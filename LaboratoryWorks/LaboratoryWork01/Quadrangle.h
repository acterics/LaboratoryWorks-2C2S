...
namespace GraphicElements
{
	...
	public:
		...
		Quadrangle(glm::vec3 pos, glm::vec3 col, glm::vec3 rot, float scale, glm::vec3 a, glm::vec3 b, glm::vec3 c, glm::vec3 d);
		~Quadrangle();
		void init() override;
	};
	...
	public:
		...
		Trapeze(glm::vec3 pos, glm::vec3 col, glm::vec3 rot, float scale, float h, float tE, float bE, float tETr);
